	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("submit"))
		{
			...
			else
			{
				...
				final String Senderid = "yashpg911@gmail.com";
				final String password = "dummy@2021";
		...
		else if(action.equalsIgnoreCase("Confirm"))
		{
			...
			ForgotPasswordModel f=new ForgotPasswordModel();
			HttpSession session=request.getSession(false);
			f=(ForgotPasswordModel)session.getAttribute("UserData");
			f.setPassword(pswd);
			f.setCustomer_id(f.getCustomer_id());
			ForgotDao dao=new ForgotDao();
