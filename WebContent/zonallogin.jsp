...
<%@ include file="header.jsp" %>
 ...
 <div class="tm-carousel"></div>
 <div class="row" >
                    <div class="col-12" style="display:flex; justify-content:center">
                        <h2 class="tm-section-header tm-header-floating">Login for Zonal Individual</h2>         
                    </div>
                </div>
<div class="row tm-welcome-row" style="display:flex; justify-content:center; margin-top:50px">
                    <div class="col-lg-6 mb-5 tm-contact-box">
                      <div class="tm-contact-form-wrap">
                        <form method="post" action="ZonalloginController"  >
                           
                  <!--   <div class="form-group">
                              <input type="text"  name="userid" class="form-control rounded-0 border-top-0 border-right-0 border-left-0" placeholder="Your UserID"  />
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="mb-3" >
  <label for="formGroupExampleInput" class="form-label">Enter UserID</label>
  <input type="text" name="userid" class="form-control" id="formGroupExampleInput" placeholder="Type your userid here">
</div>
<div class="mb-3">
