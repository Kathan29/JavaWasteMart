...
<%@ include file="header2.jsp" %>
 <div class="row">
                    <div class="col-12" style="display:flex; justify-content:center">
                        <h2 class="tm-section-header tm-header-floating">Update for active Users</h2>         
                    </div>
                </div>
                          ...
                          Gender : <% if(model.getGender().equals("male"))
                           {
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                              ...
                              <input type="hidden"  name="customerid" class="form-control rounded-0 border-top-0 border-right-0 border-left-0" value="<%=model.getCustomer_id() %>"  />
