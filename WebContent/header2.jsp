                    ...
                    <div class="tm-site-header-left">
                       <!--  <i class="far fa-2x fa-eye tm-site-icon"></i>
                        <h1 class="tm-site-name">New Vision</h1> -->
                         <img alt="icon" src="./img/wastemart-icon.png" id="icon">
                    </div>
                        ...
                        <nav class="navbar navbar-expand-lg">
                          ...
                          <div class="collapse navbar-collapse tm-nav" id="navbarSupportedContent1">
                            ...
                            <ul class="navbar-nav mr-auto">
                             <li>
                                <a class="nav-link tm-nav-link" href="home.jsp">Home <span class="sr-only"></span></a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link tm-nav-link" href="services.jsp">Services</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link tm-nav-link" href="profile.jsp">Profile</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link tm-nav-link" href="index.jsp">Logout</a>
                              </li>
                            </ul>
                            <!-- Links -->
